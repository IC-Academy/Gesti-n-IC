...
export const SOLICITUDES_SEED: Solicitud[] = [
  {
    ...
    correo: 'mariana.torres@icsecurity.com',
    telefono: '5555552244',
    descripcion: 'Revisión de fuga de agua y sustitución de plafones dañados en la sala de capacitación.',
    tiempoAproximado: 'D4_7',
    evidenciasIds: [],
    estatus: 'RECIBIDA',
    otpConfirmado: true,
    creadoEn: '2026-08-25T09:20:00.000-06:00',
    actualizadoEn: '2026-08-25T09:20:00.000-06:00',
  },
  {
    id: 'sol-0003',
    folio: 'SOL-2026-0003',
    ...
    area: 'Operaciones',
    correo: 'carlos.mendoza@intercon.com.mx',
    telefono: '5555553311',
    descripcion: 'Instalación de mobiliario fijo en un espacio que será reubicado el próximo mes.',
    tiempoAproximado: 'S1_4',
    evidenciasIds: [],
    estatus: 'RECHAZADA',
    otpConfirmado: true,
    dictamen: 'No procede por el momento: el área será reubicada. Se recomienda ingresar una nueva solicitud al confirmar la sede definitiva.',
    decididoPor: 'usr-20001',
    decididoEn: '2026-08-24T16:00:00.000-06:00',
    creadoEn: '2026-08-24T11:30:00.000-06:00',
    actualizadoEn: '2026-08-24T16:00:00.000-06:00',
  },
  {
    id: 'sol-0001',
    folio: 'SOL-2026-0001',
